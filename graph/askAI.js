...
async function askAI(question, documents = [], options = {}) {
  ...
  function defaultFollowUps(domain) {
  switch (domain) {
    case 'process':
      return [
        'Процессын хариуцагч хэн бэ?',
        'Процессын алхам бүрийн оролцогчдыг тайлбарла',
        'Процессын маягтууд хаана байдаг вэ?',
        'Энэ процесс ERP/Teams-тэй яаж холбогддог вэ?'
      ];
    case 'project':
      return [
        'Төслийн төлөвлөлтийн үндсэн үе шат юу вэ?',
        'Төслийн гүйцэтгэлийг яаж тайлагнадаг вэ?',
        'Төслийн эрсдэлийг яаж хянадаг вэ?',
        'Төслийн явцын тайлангийн давтамж ямар вэ?'
      ];
    case 'contract':
      return [
        'Гэрээний файл нэр эсвэл огноог тодруулж асуух',
        'Гэрээний төлбөрийн нөхцөлийг асуух',
        'Гэрээ дуусгавар болгох заалтыг шалгах',
        'Гэрээний хариуцлагын заалтыг тодруулах'
      ];
    default:
      return [
        'Энэ сэдвийн талаар дэлгэрэнгүй тайлбарла',
        'Холбогдох баримтын жагсаалтыг харуул',
        'Хариуцагч, холбогдох албыг хэлж өг'
      ];
  }
}
